		...
		public UnityEngine.UI.Button E_EnterServerButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_EnterServerButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_EnterServer");
     			}
		...
		public UnityEngine.UI.Image E_EnterServerImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_EnterServerImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_EnterServer");
     			}
