...
namespace ET
{
    public static class DisconnectHelper
    {
        ...
        public static async ETTask KickPlayer(this Player player, bool isException = false)
        {
                ...
                if (!isException)
                {
                    switch (player.PlayerState)
                    {
                        ...
                        case PlayerState.Game:
                            ...
                            long LoginCenterConfigSceneId = StartSceneConfigCategory.Instance.LocationConfig.InstanceId;
